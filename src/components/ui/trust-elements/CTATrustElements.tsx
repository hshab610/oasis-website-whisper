...
const CTATrustElements: React.FC<CTATrustElementsProps> = ({
  ...
  return (
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      {showDot && (
        <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground bg-white/50 backdrop-blur-sm px-3 py-1.5 rounded-full">
      ...
      {showScheduling && (
        <div className="flex items-center justify-center mt-2 text-sm px-4 py-2 bg-yellow-50 rounded-full border border-desertGold/30 shadow-sm">
