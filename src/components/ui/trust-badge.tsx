...
import { Phone, Shield, Star, Clock, BadgePercent } from "lucide-react";

interface TrustBadgeProps extends React.HTMLAttributes<HTMLDivElement> {
  type: "phone" | "insured" | "ontime" | "rating" | "discount" | "dot";
  value?: string;
  size?: "sm" | "md" | "lg";
  ...
  ({ className, type, value, size = "md", variant = "default", ...props }, ref) => {
    const getIcon = () => {
      switch (type) {
        ...
        case "rating": return <Star className={iconClassName} />;
